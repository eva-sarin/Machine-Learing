# -*- coding: utf-8 -*-
"""
Created on Sun Aug 23 22:25:27 2020
...
image_features=dataset.images.reshape((len(dataset.images),-1))  #check documentation of digits dtset to know what all to defines inisdes brackets
...
best_model=RandomForestClassifier(n_estimators=optimal_estimators,max_depth=optimal_depth)
k_fold=model_selection.KFold(n_splits=10,random_state=123)

predictions=model_selection.crossvalidation(best_model,feature_test,target_test,cv=K_fold)
